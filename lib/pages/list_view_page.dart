...
var productList = <Product>[
  ...
  Product('Cup', 'products/cup.png',
      assetsPackage: _assertPackage, price: 22, desc: '根本装不了一滴水'),
  Product('Deskset', 'products/deskset.png',
      assetsPackage: _assertPackage, price: 198, desc: '只能三选一'),
  Product('Dress', 'products/dress.png',
      assetsPackage: _assertPackage, price: 326, desc: '卖的不是这个女孩'),
  Product('Earrings', 'products/earrings.png',
      assetsPackage: _assertPackage, price: 326, desc: '普通人根本戴不进去'),
];
